...
import           Hedgehog (MonadTest, PropertyT, annotateShow, evalEither, forAll, property,
                   tripping, (===))
...
-- | Normalizations applied to original data
...
-- | Normalizations applied to roundtrip result data
